          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-2">
                ...
                <p>
                  A modern, high-performance image fetcher built using React
                  with Typescript and a backend proxy with Go
                </p>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-2">
                ...
                <p>
                  A minimalist server-rendered microblogging platform, built
                  with Express and Handlebars to simulate the architecture of
                  early web apps, this project demonstrates clean monolithic
                  architecture, RESTful routing, and persistent storage using
                  PostgreSQL
                </p>
                <div className="flex gap-2">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-2">
                ...
                <p>
                  My personal portfolio website inspired by retro operating
                  system aesthetics. Each section (About, Projects, Contact,
                  etc.) is represented as draggable "windows", giving visitors
                  an interactive and nostalgic desktop experience.
                </p>
                <div className="flex gap-2">
                  <div className="size-5">{parse(siTypescript.svg)}</div>
                  <div className="size-5">{parse(siReact.svg)}</div>
